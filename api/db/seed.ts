...
import type {
  ...
  Pipeline, Discussion, Activity, FileNode, Label,
} from "@shared/types";
...
export const users: User[] = [
  { id: "u1", name: "林知白", email: "lin@codezone.dev", avatar: "", role: "admin", createdAt: now - 180 * day },
  { id: "u2", name: "陈砚秋", email: "chen@codezone.dev", avatar: "", role: "maintainer", createdAt: now - 160 * day },
  { id: "u3", name: "苏映雪", email: "su@codezone.dev", avatar: "", role: "maintainer", createdAt: now - 120 * day },
  { id: "u4", name: "周时砚", email: "zhou@codezone.dev", avatar: "", role: "member", createdAt: now - 90 * day },
  { id: "u5", name: "顾长青", email: "gu@codezone.dev", avatar: "", role: "member", createdAt: now - 60 * day },
  { id: "u6", name: "沈听澜", email: "shen@codezone.dev", avatar: "", role: "member", createdAt: now - 30 * day },
];

export const labels: Label[] = [
  { id: "l1", name: "bug", color: "#a64953" },
  { id: "l2", name: "enhancement", color: "#5e9f7e" },
  { id: "l3", name: "feature", color: "#33a6b8" },
  { id: "l4", name: "docs", color: "#3d6896" },
  { id: "l5", name: "performance", color: "#a87a3d" },
  { id: "l6", name: "refactor", color: "#787670" },
  { id: "l7", name: "good first issue", color: "#5e9f7e" },
  { id: "l8", name: "wontfix", color: "#a8a69f" },
];
...
export const repos: Repo[] = [
  {
    ...
    ownerId: "u1", updatedAt: now - 2 * hour, openIssues: 12, openPRs: 4,
  },
  {
    ...
    ownerId: "u2", updatedAt: now - 5 * hour, openIssues: 8, openPRs: 3,
  },
  {
    ...
    ownerId: "u3", updatedAt: now - 1 * day, openIssues: 5, openPRs: 1,
  },
  {
    ...
    ownerId: "u1", updatedAt: now - 3 * day, openIssues: 3, openPRs: 0,
  },
  {
    ...
    ownerId: "u4", updatedAt: now - 6 * hour, openIssues: 6, openPRs: 2,
  },
];
...
export const issues: Issue[] = [
  {
    ...
    labels: [labels[0], labels[5]], milestone: "v2.4", createdAt: now - 3 * day, updatedAt: now - 4 * hour, commentCount: 7,
  },
  {
    ...
    labels: [labels[4]], milestone: "v2.4", createdAt: now - 5 * day, updatedAt: now - 1 * day, commentCount: 4,
  },
  {
    ...
    labels: [labels[2]], milestone: null, createdAt: now - 7 * day, updatedAt: now - 7 * day, commentCount: 2,
  },
  {
    ...
    labels: [labels[0], labels[1]], milestone: "v2.4", createdAt: now - 2 * day, updatedAt: now - 6 * hour, commentCount: 3,
  },
  {
    ...
    labels: [labels[2]], milestone: "v2.5", createdAt: now - 4 * day, updatedAt: now - 2 * day, commentCount: 5,
  },
  {
    ...
    labels: [labels[0]], milestone: null, createdAt: now - 6 * day, updatedAt: now - 6 * day, commentCount: 1,
  },
  {
    id: "i7", repoId: "r1", number: 139, title: "流水线日志支持搜索与高亮",
    body: "长日志（>5000 行）难以定位失败原因。增加关键字搜索、错误行高亮与折叠。",
    status: "open", priority: "normal", assigneeId: null,
    labels: [labels[2], labels[1]], milestone: "v2.5", createdAt: now - 8 * day, updatedAt: now - 8 * day, commentCount: 0,
  },
  {
    ...
    labels: [labels[3]], milestone: null, createdAt: now - 14 * day, updatedAt: now - 10 * day, commentCount: 2,
  },
  {
    ...
    labels: [labels[0], labels[3]], milestone: "v2.5", createdAt: now - 9 * day, updatedAt: now - 9 * day, commentCount: 3,
  },
  {
    ...
    labels: [labels[4]], milestone: "v2.3", createdAt: now - 18 * day, updatedAt: now - 12 * day, commentCount: 6,
  },
];
...
export const pullRequests: PullRequest[] = [
  {
    ...
    reviewers: ["u3", "u1"], createdAt: now - 4 * hour, updatedAt: now - 1 * hour, commentCount: 3,
    files: [
      {
  ...
  },
  {
    ...
    reviewers: ["u1"], createdAt: now - 8 * hour, updatedAt: now - 3 * hour, commentCount: 5,
    files: [
      {
  ...
  },
  {
    ...
    reviewers: ["u2"], createdAt: now - 6 * hour, updatedAt: now - 2 * hour, commentCount: 2,
    files: [
      {
  ...
  },
  {
    ...
    reviewers: [], createdAt: now - 3 * day, updatedAt: now - 1 * day, commentCount: 1,
    files: [],
  },
];
